...
//STUDENTS
        Student student=restTemplate.getForObject(
                " http://10.51.10.111:1000/registrations",Student.class);
        System.out.println(student.toString());

        System.err.println("Creating(POST)______________________________");

        Student newStudent= new Student("Mary Watiri", "094499");
        Student createdStudent =restTemplate.postForObject("http://10.51.10.111:1000/registrations",+createdStudent.getId()+"/students");
